...
function Slide() {
    ...
    return (
        <div className='slidebar'>
            <Carousel black>
                <Carousel.Item>
                    <img src="https://neemans.com/cdn/shop/files/ND_-_COB_-_Web_Banner_-_Desktop_1920_x_800_px.jpg?v=1739879182&width=1500" alt="" />
                    <Carousel.Caption>

                    </Carousel.Caption>
                </Carousel.Item>
                <Carousel.Item>
                    <img src="https://neemans.com/cdn/shop/files/Web_Banner_UC_-_Desktop_1920_x_800.jpg?v=1740038766&width=1500" alt="" />
